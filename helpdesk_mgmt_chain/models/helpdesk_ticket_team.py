...
class HelpdeskTeam(models.Model):
    ...
    _name = "helpdesk.ticket.chain.team"
    _description = "Helpdesk Ticket Chain Team"
    ...
    category_ids = fields.Many2many(
        comodel_name="helpdesk.ticket.chain.category", string="Category"
    )
    ...
    ticket_ids = fields.One2many(
        comodel_name="helpdesk.ticket.chain",
    ...
    def _compute_todo_tickets(self):
        ticket_model = self.env["helpdesk.ticket.chain"]
    ...
    def _alias_get_creation_values(self):
        ...
        values["alias_model_id"] = self.env.ref(
            "helpdesk_mgmt_chain.model_helpdesk_ticket_chain"
        ).id
