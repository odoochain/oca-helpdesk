...
class TestHelpdeskTicketTeam(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        helpdesk_ticket_team = cls.env["helpdesk.ticket.chain.team"]
        ...
        cls.mail_alias_id = mail_alias.create(
            {
                ...
                .search([("model", "=", "helpdesk.ticket.chain")])
                .id,
            }
        )
    ...
    def test_helpdesk_ticket_todo(self):
        self.assertEqual(
            ...
            2,
            "Helpdesk Ticket Chain: Helpdesk ticket team should " "have two tickets to do.",
        )
        self.assertEqual(
            self.team_id.todo_ticket_count_unassigned,
            1,
            "Helpdesk Ticket Chain: Helpdesk ticket team should "
        ...
        self.assertEqual(
            self.team_id.todo_ticket_count,
            1,
            "Helpdesk Ticket Chain: Helpdesk ticket team should " "have one ticket to do.",
        )
