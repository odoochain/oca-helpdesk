...
{
    "name": "Law Helpdesk Ticket Type",
    "version": "15.0.1.0.0",
    "license": "AGPL-3",
    "summary": "Add a type to your tickets",
    "author": "Oddchain, " "Konos, " "Open Source Integrators, " "Odoo Community Association (OCA)",
    "website": "https://github.com/odoochain/oca-helpdesk",
    "depends": ["helpdesk_mgmt_chain"],
    "data": [
    ...
    "demo": ["demo/helpdesk_type_chain_demo.xml"],
    "application": False,
